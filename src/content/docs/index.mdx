...
description: Bienvenido a nuestro Portal de Transparencia. Accede a información pública, transparencia institucional y datos abiertos sobre nuestra organización.
template: doc
---
...
<Image src={logoImage} alt="Logotipo de Infinity Transparencia" class="logo-animation" />
...
<div class="card-grid">
  <ImageCard
    ...
    description="Detalles sobre nuestra estructura y misión."
  ...
  <ImageCard
    ...
    description="Estructura y funcionamiento interno."
  ...
  <ImageCard
    ...
    description="Datos y balances financieros."
  ...
  <ImageCard
    ...
    description="Listado de contratos y acuerdos."
  ...
  <ImageCard
    ...
    description="Registro de subvenciones recibidas."
