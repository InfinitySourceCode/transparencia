...
template: doc
hero:
  tagline: Estamos comprometidos con la máxima rendición de cuentas y la apertura total en nuestra gestión, inspirados en los principios de buen gobierno y acceso a la información pública.
  image:
    file: ../../assets/images/transparencia.jpg
    alt: Portal de Transparencia de Asociación Solidaria Infinity
---
...
Utilizamos formatos abiertos para los archivos con datos que exponemos siempre que es posible. También publicamos el código fuente de nuestro portal de transparencia en Git Hub.
</Aside>
...
<LinkCard
  ...
  description="Conoce nuestra organización."
/>
